...
define("appmsg/channel/channels.js",["biz_common/tmpl.js","biz_common/dom/event.js","biz_wap/jsapi/core.js","appmsg/appmsg_card.js","appmsg/channel/video_snap_tpl.html.js","biz_wap/utils/ajax.js","biz_wap/utils/mmversion.js","biz_wap/utils/device.js","pages/utils.js","common/utils.js","common/comm_report.js"],function(e,t,n,i){
"use strict";
function a(){
return!y.isWechat||I.os.pc||y.is_wxwork?!1:y.isIOS&&y.ltVersion("7.0.15",!1)?!1:y.isAndroid&&window.clientversion<="27001337"?!1:!0;
}
function o(e,t,n){
var i=0;
try{
...
f.invoke("openFinderView",{
extInfo:r
},function(e){
console.log("openFinderDetailView",e);
});
}else y.isWechat&&I.os.pc?window.weui.alert("当前版本暂不支持查看，请在手机上查看"):(!y.isWechat||y.is_wxwork)&&i("请在微信内打开"),
o(3,e,n),!y.isWechat||I.os.pc||y.is_wxwork||x.jumpUrl("https://support.weixin.qq.com/update/",!0);
}
function s(e){
...
var t=e.parentNode;
if(t){
var n=t.getAttribute("data-id"),i=s(n),a=void 0;
i&&i.length>0&&(a=i[0]);
var o=a&&a.nonce_id?a.nonce_id:t.getAttribute("data-nonceid"),d=a&&a.flag||0,c=a&&a.username?a.username:t.getAttribute("data-username");
0===d&&r(n,o,c);
}
}
function c(){
...
function u(){
if(C&&C.length&&k.length===C.length)return void v.off(window,"scroll",u);
for(var e=0;e<C.length;e++){
var t=C[e],n=t.firstChild;
if(n&&n.getBoundingClientRect().top>0&&n.getBoundingClientRect().top+n.getBoundingClientRect().height/2<=A.getInnerHeight()){
var i=t.getAttribute("data-id"),a=t.getAttribute("data-username");
-1===k.indexOf(i)&&(k.push(i),o(1,i,a));
}
}
}
function m(){
c(),p(),v.on(window,"scroll",u);
}
function l(){
var e=document.getElementById("js_content");
if(e){
C=e.getElementsByTagName("mpvideosnap")||[];
for(var t=0;t<C.length;t++){
var n=C[t],i=n.getAttribute("data-id")||"",a=s(i),o=a.length>0?a[0]:{},r=void 0,d=4===o.media_type?"video":"image";
r={
snapType:o&&o.media_type?d:n.getAttribute("data-type"),
url:o.feed_thumb_url||o.feed_cover_url||n.getAttribute("data-url")||"",
headImgUrl:o.head_url||n.getAttribute("data-headimgurl")||"",
nickname:o.nickname||n.getAttribute("data-nickname")||"",
desc:o.feed_desc||n.getAttribute("data-desc")||"",
flag:o.flag||0
},"image"===r.snapType&&(r=_extends(r,{
imgCount:parseInt(o.media_num||"0",10)||parseInt(n.getAttribute("data-imgcount")||"0",10)||0
}));
var c=document.createElement("div");
c.innerHTML=_.tmpl(b,r),c.firstElementChild&&n.appendChild(c.firstElementChild);
...
video_snap_num:e.length
},i={},a=0;a<n.video_snap_num;a++){
var o=e[a].export_id,r=e[a].username;
i[o]?i[o].push(a):(i[o]=[a],n["exportid_"+a]=o,n["username_"+a]=r);
}
var s="/mp/appmsg_video_snap?action=batch_get_video_snap";
for(var d in n)Object.prototype.hasOwnProperty.call(n,d)&&(s+="&"+d+"="+encodeURIComponent(n[d]));
j({
url:s,
type:"GET",
dataType:"json",
async:!0,
success:function(e){
e&&e.base_resp&&0===e.base_resp.ret&&(E=e.video_snap_info||[]),l();
},
error:function(){
l();
}
...
var _=e("biz_common/tmpl.js"),v=e("biz_common/dom/event.js"),f=e("biz_wap/jsapi/core.js"),h=e("appmsg/appmsg_card.js"),b=e("appmsg/channel/video_snap_tpl.html.js"),j=e("biz_wap/utils/ajax.js"),y=e("biz_wap/utils/mmversion.js"),I=e("biz_wap/utils/device.js"),x=e("pages/utils.js"),A=e("common/utils.js"),z=e("common/comm_report.js"),C=[],E=[],k=[];
g();
});var _extends=Object.assign||function(e){
